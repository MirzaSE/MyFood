...
namespace MyFood.Tests.E2E
{
    ...
    public class AuthenticationE2ETests : ApiE2ETestBase
    {
        ...
        public async Task Register_WithDuplicateUsername_ReturnsBadRequest()
        {
            ...
            var model = new { username, email = "duplicateuser@example.com", password };
            var content = new StringContent(
                JsonSerializer.Serialize(model),
                Encoding.UTF8,
                "application/json");
        ...
        public async Task Login_WithValidCredentials_ReturnsTokenAndExpiration()
        {
            ...
            // Register first
            var registerModel = new { username, email = "loginuser@example.com", password };
        ...
        public async Task Login_WithInvalidPassword_ReturnsUnauthorized()
        {
            ...
            // Register
            var registerModel = new { username, email = "validuser@example.com", password };
            var registerContent = new StringContent(
                JsonSerializer.Serialize(registerModel),
                Encoding.UTF8,
                "application/json");

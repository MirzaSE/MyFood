        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden sm:flex items-center space-x-1">
              {navLink('/foods', 'Foods', UtensilsCrossed)}
              {navLink('/ingredients', 'Ingredients', Leaf)}
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-3 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-300 hover:text-red-200 rounded-lg transition-all duration-200 border border-red-500/30 hover:border-red-500/50"
            >
              <LogOut size={18} />

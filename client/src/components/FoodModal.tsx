          ...
          <div className="mt-8">
            ...
            <input
              {...register('name', {
                ...
                maxLength: { value: 100, message: 'Name can be at most 100 characters' },
              })}
              type="text"
          ...
          <div className="mt-8">
            ...
            <input
              {...register('type', {
                ...
                maxLength: { value: 50, message: 'Type can be at most 50 characters' },
              })}
              type="text"
          ...
          <div>
            ...
            <input
              {...register('calories', {
                ...
                max: { value: 10000, message: 'Calories can be at most 10000' },
              })}
              type="number"
              min={1}
              max={10000}

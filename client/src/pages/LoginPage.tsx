...
export const LoginPage: React.FC = () => {
  ...
  const registerForm = useForm<RegisterFormData>({ mode: 'onSubmit' });
  ...
  try {
    ...
    console.log('Login error:', msg, err.response);
    setLoginError(msg);
  }
};
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            {activeTab === 'login' && (
              <>
                {loginError && (
                  <div className="mb-4 p-4 bg-red-500/20 border border-red-500/50 rounded-lg flex items-start space-x-3">

...
namespace MyFood.Api.Controllers.v1
{
    ...
    public class IngredientsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IngredientDto>> AddIngredient(ApiVersion version, [FromBody] CreateIngredientDto createIngredientDto)
        {
            ...
            try
            {
                ingredientDto = await _ingredientService.CreateIngredientAsync(createIngredientDto);
            }
        ...
        public async Task<ActionResult<IngredientDto>> UpdateIngredient(int id, [FromBody] UpdateIngredientDto updateIngredientDto)
        {
            ...
            try
            {
                ingredientDto = await _ingredientService.UpdateIngredientAsync(id, updateIngredientDto);
            }
            catch (ArgumentException ex)
            {
                return BadRequest(new { message = ex.Message });

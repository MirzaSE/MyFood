...
public class FoodService : IFoodService
{
    ...
    {
        FoodEntity? foodEntity = _foodRepository.GetSingle(id);
        FoodDto? foodDto = _mapper.Map<FoodDto?>(foodEntity);
        return Task.FromResult(foodDto);
    }
    ...
    public async Task<IEnumerable<FoodDto>> GetRandomMealAsync()
    {
        ...
        return await Task.FromResult(foodItems.Select(x => _mapper.Map<FoodDto>(x)));
    }
    ...
    {
        IEnumerable<FoodEntity> foodEntities = _foodRepository.SearchFoodsByName(name);
        IEnumerable<FoodDto> foodDtos = _mapper.Map<IEnumerable<FoodDto>>(foodEntities);
        return Task.FromResult(foodDtos);
    }
